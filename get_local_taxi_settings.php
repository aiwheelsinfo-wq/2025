...
echo json_encode([
    ...
    'global_settings' => [
        ...
        'traffic_pricing_active' => !isset($global['traffic_pricing_active']) || !empty($global['traffic_pricing_active']),
        'traffic_grace_minutes' => (int)($global['traffic_grace_minutes'] ?? 5),
        'traffic_max_cap_minutes' => (int)($global['traffic_max_cap_minutes'] ?? 60),
